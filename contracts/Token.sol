...
contract Token is ERC20Interface, Owned, SafeMath {
   ...
   */
    function mintTokens(address user, uint256 _value) external {
        increaseSupply(_value);
        increaseBalance(user, _value);
        // emit Transfer(address(0), msg.sender, _value);
    }

    function increaseSupply(uint _value) private {
        _totalSupply = safeAdd(_totalSupply, _value);
    }

    function increaseBalance(address _owner, uint256 _value) private {
